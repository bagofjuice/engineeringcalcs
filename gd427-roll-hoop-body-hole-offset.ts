// JS fiddle version: https://jsfiddle.net/u1x4gqyr/
...
const rollHoopsConfigA: HoopOffsets = {
  ...
  visualiseHolePositions(rollHoopsConfigA.nearside, "hoop_nearside");
  visualiseHolePositions(rollHoopsConfigA.offside, "hoop_offside");
